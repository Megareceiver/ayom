...
function headerAdmin(){
	...
	'<div class="content-frame">'+
		'<div class="col-xs-5 col-md-3">'+
			'<div class="logo"><img class="medium-image" src="../assets/img/ayomlogo.png" /></div>'+
		'</div>'+
...
function pageAdmin(){
		...
		'<div class="row">'+
			'<div class="col-md-3 left-nav">'+
				'<div class="list-nav">'+
					...
					'<ul class="toggle-target">' +
						...
						// '<li class="category-route"><a href="category.html">CATEGORY</a></li>'+
						...
						// '<li class="report-route"><a href="reports.html">REPORTS</a></li>'+
			...
			'<div class="col-md-9 col-md-offset-3 syn-clear di-left">'+
				'<div class="col-md-12 top-nav">'+
					'<ul>' +
						'<li class="product-route"><a href="product_equipment.html">Equipments</a></li>'+
						'<li class="product-route"><a href="product_foods.html">Foods</a></li>'+
						'<li class="product-route"><a href="product_medical.html">Medical</a></li>'+
						'<li class="product-route"><a href="product_category.html">Categories</a></li>'+
					'</ul>' +
				'</div>'+
	...
	if(page != null && page.length > 0){
		...
		switch(page){
			...
			case "formUser.html": case "setting.html": $(".setting-route").addClass('active'); break;
